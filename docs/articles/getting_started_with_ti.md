...
> For most of your uses cases, you are likely to reference “standard”
> calendar which is your standard gregorian calendar: - 365 days in a
> year except for leap years where you have 366, 7 days make up a week,
...
The print statement summarizes the below categories:

- A brief description of what the function is doing
- A summary of the calendar that was created for the analysis, including
  any missing dates and new column that were created
- Highlights of the key actions performed
- What are the possible next steps to further transform your ti object
...
Each group will have a complete calendar ensuring no group member has
any missing dates.
...
- Issue 2: Period imbalances between periods (Eg. the different number
  of days between February vs. January) can create misleading analysis
  or trends or you analysis requires non-standard calendar types
...
often will compare a period with unequal number of days or periods.
