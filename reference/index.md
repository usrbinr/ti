...
- [`augment_standard_calendar()`](https://codeberg.org/usrbinr/fpa/reference/augment_standard_calendar.md)
...
- [`cohort()`](https://codeberg.org/usrbinr/fpa/reference/cohort.md) :
  Cohort Analysis
- [`abc()`](https://codeberg.org/usrbinr/fpa/reference/abc.md) : ABC
  classification function

## Monthly Functions

- [`mtd()`](https://codeberg.org/usrbinr/fpa/reference/mtd.md) : Current
  period month-to-date
- [`pmtd()`](https://codeberg.org/usrbinr/fpa/reference/pmtd.md) :
  Previous period month-to-date
- [`mom()`](https://codeberg.org/usrbinr/fpa/reference/mom.md) : Current
...
- [`qtd()`](https://codeberg.org/usrbinr/fpa/reference/qtd.md) : Current
  period quarter-to-date
- [`pqtd()`](https://codeberg.org/usrbinr/fpa/reference/pqtd.md) : Prior
  period quarter-to-date
- [`qoq()`](https://codeberg.org/usrbinr/fpa/reference/qoq.md) : Current
...
- [`wtd()`](https://codeberg.org/usrbinr/fpa/reference/wtd.md) : Current
  period week-to-date
- [`pwtd()`](https://codeberg.org/usrbinr/fpa/reference/pwtd.md) :
  Previous period week-to-date
- [`wow()`](https://codeberg.org/usrbinr/fpa/reference/wow.md) : Current
...
- [`dod()`](https://codeberg.org/usrbinr/fpa/reference/dod.md) : Current
  period day over previous period day

## Yearly & All of time Functions

- [`atd()`](https://codeberg.org/usrbinr/fpa/reference/atd.md) : All
  period-to-date
- [`ytd()`](https://codeberg.org/usrbinr/fpa/reference/ytd.md) : Current
  period year-to-date
- [`pytd()`](https://codeberg.org/usrbinr/fpa/reference/pytd.md) :
  Previous period year-to-date
- [`yoy()`](https://codeberg.org/usrbinr/fpa/reference/yoy.md) : Current
