...
`ti` package is a collection of business intelligence tools designed to simplify common **financial planning and analysis (FP&A)** tasks such as time intelligence calculations, group members segmentation and factor/variance analysis.
